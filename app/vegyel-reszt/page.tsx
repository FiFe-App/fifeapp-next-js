import { Box, Container, Flex, Heading, Text, ScrollArea } from '@radix-ui/themes'
            ...
            <Container size="3" mt="8">
                ...
                <Text>
                    ...
                    <Box m='5' className={styles.container} >
                        ...
                        <Text>Ha csatlakozni szeretnél <Link href='mailto:kristofakos1229@gmail.com'>írj emailt</Link>!</Text>
